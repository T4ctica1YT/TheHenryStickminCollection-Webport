   ...
   public class BiosMain
   {
      ...
      public function Unlock(param1:DisplayObjectContainer, param2:String) : void
      {
         ...
         if(!this.bios[param2])
         {
            ...
            if(param1 != null)
            {
               _loc4_ = new this.popup();
               _loc5_ = MovieClip(_loc4_.getChildAt(0));
               _loc5_.value = param2;
               _loc4_.x = param1.stage.mouseX - 15;
               _loc4_.y = param1.stage.mouseY - 15;
               param1.stage.addChild(_loc4_);
            }
            _loc3_ = param2.indexOf("_");
            if(_loc3_ != -1)
            {
               _loc6_ = param2.substr(0,_loc3_);
