package MainMenu_fla
{
   ...
   public dynamic class FtC_Button_102 extends MovieClip
   {
      
      public function FtC_Button_102()
      {
         super();
      ...
      internal function frame1() : *
      {
         ...
         {
            if(MainScene.instance.GetMenuUnlockedFrame() < MainScene.UnlockedFtC)
            {
            ...
            {
               MainScene.instance.ScrollBackground(4);
            });
         }
      }
