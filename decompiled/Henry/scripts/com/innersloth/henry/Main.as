package com.innersloth.henry
{
   ...
   public class Main extends Sprite
   {
      ...
      {
         if(Boolean(this.loaderFtC.content) && Boolean(this.loaderCtM.content) && Boolean(this.loaderCtM2))
         {
      ...
      public function StartFtC(skipIntro:Boolean) : void
      {
         ...
         {
            if(Boolean(this.loaderFtC.content))
            {
      ...
      public function StartCtM() : void
      {
         ...
         {
            if(Boolean(this.loaderCtM.content))
            {
